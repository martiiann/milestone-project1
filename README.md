...
![About Page Screenshot](README-images/about_page_screenshot.png)
...
![Gallery Page Screenshot](README-images/GalleryPageScreenshot.png)
...
![Price Page Screenshot](README-images/PricePageScreenshot.png)
...
![Contact Page Screenshot](README-images/ContactPage%20Screenshot.png)
...
- **HTML Validation**: Each page has been validated using the [W3C Markup Validator](https://validator.w3.org/#validate_by_input) to ensure no syntax errors. Screenshots for validation results are provided below:
  ...
  ![HTML Validation Screenshot for About Page](README-images/About_page(index.html).png)
  ![HTML Validation Screenshot for Gallery Page](README-images/Gallery_test.png)
  ![HTML Validation Screenshot for Price Page](README-images/Price_test.png)
  ![HTML Validation Screenshot for Contact Page](README-images/Contact_test.png)
...
- **CSS Validation**: CSS code has been validated through the [W3C CSS Validator](https://jigsaw.w3.org/css-validator/), ensuring the styling adheres to standards.
  ...
  ![CSS Validation Screenshot](README-images/CSS_test.png)
...
- **Lighthouse Performance Scores**: The website’s Lighthouse scores have been consistently high, showcasing fast load times and good SEO. Screenshots of the performance reports are below:
  ...
  ![Lighthouse Performance Screenshot](README-images/lighthouse_performance.png)
...
- **Responsiveness**: The site has been tested on multiple devices and screen sizes to ensure it is fully responsive. Here are screenshots of the site across devices:
  ...
  - **Desktop View**:
    ![Desktop View Screenshot](README-images/desktop_view.png)

  - **Tablet View**:
    ![Tablet View Screenshot](README-images/tablet_view.png)

  - **Mobile View**:
    ![Mobile View Screenshot](README-images/mobile_view.png)
